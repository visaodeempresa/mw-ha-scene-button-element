...
REPO = "visaodeempresa/mw-ha-scene-button-element"          # dono/repositório no GitHub
NOME = "mw-ha-scene-button-element"                    # a pasta em /config/www/community
CARD = "mw-scene-button-element"                    # o arquivo .js, sem extensão
